...
class HypeStacker(BaseEstimator, RegressorMixin):
    ...
    Full stacked regressor:
      ...
      - Base models: XGB, LGBM, CatBoost, RF, Ridge, KNN, AdaBoost, GBR, SVR
    ...
    def __init__(self,
        ...
        self.rf_: Optional[RandomForestRegressor] = None
    ...
    def _fit_base_models(self, X_enc, X_raw_cb, y, RSEED):
        ...
        self.rf_ = RandomForestRegressor(
            n_estimators=300, max_depth=30, min_samples_split=20,
            min_samples_leaf=2, random_state=RSEED, n_jobs=-1
        )
        ...
        self.svr_ = SVR(C=10.0, epsilon=0.01, kernel="rbf", gamma="scale")
        ...
        self.rf_.fit(X_enc, y)
        # Ridge/SVR need dense
    ...
    def _save_artifacts(self):
        ...
        for name in ["rf_", "ridge_", "knn_", "adaboost_", "gbr_", "svr_", "meta_"]:
